...
<form class="form-signin" action="${path}" method="post">
    ...
    <div class="form-label-group">
        <input type="text" id="username" name="username" class="form-control" placeholder="Login" required="required"
...
<form class="form-signin" action="${path}" method="post">
    ...
    <div class="form-label-group">
        <input type="password" id="inputPassword2" name="password2" class="form-control" placeholder="Repeat password" required="required"
               autocomplete="off">
